...
my_lr = MyLR(theta1, alpha=1e-5, max_iter=20000)
my_lr.fit_(x_, Y)
...
my_lr = MyLR(theta2, alpha=1e-5, max_iter=20000)
my_lr.fit_(x_, Y)
...
my_lr = MyLR(theta3, alpha=1e-5, max_iter=20000)
my_lr.fit_(x_, Y)
...
my_lr = MyLR(theta4, alpha=1e-6, max_iter=200000)
my_lr.fit_(x_, Y)
...
my_lr = MyLR(theta5, alpha=5e-8, max_iter=200000)
my_lr.fit_(x_, Y)
...
my_lr = MyLR(theta6, alpha=1e-9, max_iter=200000)
my_lr.fit_(x_, Y)
